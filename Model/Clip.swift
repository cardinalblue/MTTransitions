...
public protocol VideoCompositionTrackProvider: AnyObject {
    ...
    func videoCompositionTrack(at index: Int, for composition: AVMutableComposition, preferredTrackID: Int32) -> AVCompositionTrack?
}
...
extension Clip: VideoCompositionTrackProvider {
    ...
    public func videoCompositionTrack(at index: Int, for composition: AVMutableComposition, preferredTrackID: Int32) -> AVCompositionTrack? {
